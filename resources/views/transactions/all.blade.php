                    ...
                    <form class="form-inline" token="{{Session::get('access_token')}}">
                        ...
                        <div class="input-daterange"> 
                            <div class="form-group">
                                ...
                                <input id="to_date" name="to_date" type="date" placeholder="Date de transaction" class="mr-3 form-control input-datepicker transaction">
                            ...
                            <div class="form-group">
                                ...
                                <input id="from_date" name="form_date" type="date" placeholder="Date de transaction" class="mr-3 form-control input-datepicker transaction">
